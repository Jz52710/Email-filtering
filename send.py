...
class Send():
    def __init__(self):
        self.email_from = "864278318@qq.com"  # 改为自己的发送邮箱
        self.email_to = ""  # 接收邮箱
        self.hostname = "smtp.qq.com"  # 不变，QQ邮箱的smtp服务器地址
        self.login = "864278318@qq.com"  # 发送邮箱的用户名
        self.password = "nodymzbgpzlqbffi"  # 发送邮箱的密码，即开启smtp服务得到的授权码。注：不是QQ密码。
        self.subject = "python+smtp"  # 邮件主题

    def sendEmail(self,con,email_to,item):
